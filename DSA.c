...
struct node5 *start5=NULL;

void PushStackLL()
{
        struct node5 *temp5,*ptr5;
        temp5=(struct node5 *)malloc(sizeof(struct node5));
        if(temp5==NULL)
        {
                printf("\nStack overflow!!!!!.....\n");
                exit(0);
...
//...............to find wheter an equation is balanced or not using stack................
...
//variables of Doubly Linked List
    ...
    //menue choice of stack menue
    int choice5;
    int exit=0;
    //submenue variabls of main stack menue program
    int exit10=0;
    int Balanced;
    int choice10;
...
do
{
printf("-----------------------Doubly Linked List MENUE----------------------\n");
...
case 5:
  do{
                ...
                printf("\n 4.check whether the equation is balanced or not using stack \n");
                printf("\n 5.Exit       \n");
                printf("\n--------------------------------------\n");
                printf("\nEnter your choice:\n");
                scanf("%d",&choice5);
